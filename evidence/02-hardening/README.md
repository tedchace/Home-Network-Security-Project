...
The Guest subnet is established by [Nmap evidence](../04-nmap/README.md), not these app views. The [client/router DNS exchange](../05-wireshark/01-dns-resolution-analysis.png) does not identify the upstream resolver. [WPA3 evidence](../03-wifite/03-wpa3-enablement-confirmation.png) remains an enablement prompt, with completion user-reported. [Isolation validation](../../documentation/remediation-validation.md) remains scoped to the supplied tests.
